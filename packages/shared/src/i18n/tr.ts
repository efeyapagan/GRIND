...
export const tr = {
  ...
  profil: {
    ...
    sifreEnFazla72Bayt: 'Şifre en fazla 72 bayt olabilir.',
    sifrelerEslesmiyor: 'Şifreler eşleşmiyor.',
    sifreIpucu: 'En az 8 karakter',
    mevcutKullaniciAdi: 'Şu anki kullanıcı adın',
    kullaniciAdiUygun: 'Bu kullanıcı adı uygun.',
    kullaniciAdiKontrolEdiliyor: 'Kontrol ediliyor…',
    kullaniciAdiKontrolEdilemedi: 'Kullanıcı adı kontrol edilemedi.',
    kullaniciAdiDegistir: 'Kullanıcı adı değiştir',
    kullaniciAdiniKaydet: 'Kullanıcı adını kaydet',
    yeniKullaniciAdi: 'Yeni kullanıcı adı',
    kullaniciAdinGuncellendi: 'Kullanıcı adın güncellendi.',
    kullaniciAdiKurali: 'Kullanıcı adı 3-50 karakter olmalı; yalnızca İngilizce harf, rakam, _ ve - içerebilir.',
    kullaniciAdiAlinmis: 'Bu kullanıcı adı zaten alınmış.',
    kullaniciAdiDegismedi: 'Yeni bir kullanıcı adı gir.',

...
namespace Grind.Api.Data.Migrations
{
    ...
    [Migration("20260925204510_AddOverHeadRopeExtensionAlias")]
    partial class AddOverHeadRopeExtensionAlias
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grind.Api.Models.Entities.Exercise", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 43L,
                            AlternateName = "Over Head Rope Extension",
                            Category = "Push",
                            IsArchived = false,
                        ...
                        {
                            Id = 72L,
                            AlternateName = "Smith Machine Low Incline Press",
                            Category = "Push",
                            IsArchived = false,
                        ...
                        {
                            Id = 83L,
                            AlternateName = "Chest Fly Machine",
                            Category = "Push",
                            IsArchived = false,
                            Name = "Pec Deck"
                        },
                        ...
                        {
                            Id = 111L,
                            AlternateName = "Dumbell Lateral Raise",
                            Category = "Push",
                            IsArchived = false,
            ...
            modelBuilder.Entity("Grind.Api.Models.Entities.Follow", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Grind.Api.Models.Entities.UserAvatar", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Grind.Api.Models.Entities.Follow", b =>
                {
                    b.HasOne("Grind.Api.Models.Entities.User", "Followee")
                        .WithMany()
                        .HasForeignKey("FolloweeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Grind.Api.Models.Entities.User", "Follower")
                        .WithMany()
            ...
            modelBuilder.Entity("Grind.Api.Models.Entities.UserAvatar", b =>
                {
                    b.HasOne("Grind.Api.Models.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("Grind.Api.Models.Entities.UserAvatar", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

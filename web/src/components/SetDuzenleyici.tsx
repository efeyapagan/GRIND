...
export default function SetDuzenleyici({ kayit, sira, onKapat, onSil }: Props) {
  ...
  return (
    <li className="rounded-lg bg-surface-2 p-3">
      <form aria-label={t('setler.duzenleFormEtiketi', { sira })} onSubmit={kaydet} className="flex flex-col gap-3">
        ...
        <div className="flex gap-2">
          <div className="flex-1">
            <IkincilDugme onClick={onKapat}>{t('ortak.vazgec')}</IkincilDugme>
          </div>
          <div className="flex-1">

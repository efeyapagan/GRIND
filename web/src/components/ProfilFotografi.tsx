...
import { useProfilFotografi, type FotografSahibi } from '../api/queries';
import { basHarf } from '../lib/profilFotografi';

const BOYUT = { kucuk: 'size-11 text-body-lg', orta: 'size-20 text-title', buyuk: 'size-24 text-title' } as const;
